    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16 items-center">
        ...
        <div class="hidden md:flex space-x-6 text-white font-medium">
          <a href="#" class="hover:text-yellow-300 transition">Acceuil</a>
          <a href="#" class="hover:text-yellow-300 transition">À propos</a>
          <a href="#" class="hover:text-yellow-300 transition">Compétences</a>
          <a href="#" class="hover:text-yellow-300 transition">Projets</a>
          <a href="#" class="hover:text-yellow-300 transition">Contact</a>
        </div>

        <!-- Desktop Button -->
        <div class="hidden md:block">
          <a href="#" class="bg-white text-indigo-700 px-4 py-2 rounded-xl hover:bg-yellow-300 transition-all font-semibold">
            Telecharger mon cv
          </a>
        </div>
            ...
            <div class="flex flex-col lg:flex-row items-center">
                <div class="lg:w-1/2 mb-12 lg:mb-0">
                    <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                        I am Aminata Traore <span class="gradient-text bg-gradient-to-r from-pink-500 to-yellow-500">développeuse Frontend & Backend passionnée</span>
                    </h1>
                    <p class="text-xl text-blue-100 mb-8 max-w-lg">
Je transforme des idées en expériences digitales                    </p>
...
Contactez-moi                        </button>
    ...
    <div class="font font-Poppins bg-green-100 min-h-80">
  <div class="flex flex-col items-center relative pt-20 overflow-hidden">
    <!-- Animated Background Text -->
    <h1 class="absolute text-4xl md:text-[6rem] font-bold text-black-100 opacity-1 animate-pulse">
      ABOUT ME
    </h1>
    ...
    <!-- Optional subtitle -->
    <p class=" pt-50 text-gray-400 text-center max-w-md md:max-w-2xl px-6 text-sm md:text-base animate-fade-in">
