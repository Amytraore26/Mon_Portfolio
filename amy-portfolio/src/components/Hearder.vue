...
<body class="bg-black text-white overflow-x-hidden">
  ...
  <section class="pt-1 overflow-hidden black dark:bg-gray-800 md:pt-0 sm:pt-16 2xl:pt-16">
    <h1 class="text-5xl font-bold text-center bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent text-glow>A propos de moi"> À Propos de moi </h1>
