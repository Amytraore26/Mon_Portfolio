<template>
  <section class="container mx-auto px-4 py-16 md:py-24">
    <h2 class="text-4xl md:text-5xl font-bold text-center dark:text-white mb-20 bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent text-glow">
      Formation
    </h2>
    ...
    <div class="relative">
      ...
      <div class="space-y-12 md:space-y-24">
        ...
        <div class="timeline-item flex flex-col md:flex-row items-center relative">
          ...
          <!-- Icon -->
          <div class="flex justify-center md:absolute md:left-1/2 md:transform md:-translate-x-1/2 mt-4 md:mt-0 z-10">
        ...
        <!-- Item 2 -->
        <div class="timeline-item flex flex-col md:flex-row items-center relative">
          <div class="md:w-1/2 md:pr-12 mt-4 md:mt-0">
          ...
          <!-- Icon -->
          <div class="flex justify-center md:absolute md:left-1/2 md:transform md:-translate-x-1/2 mt-4 z-10">
